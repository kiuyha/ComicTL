<script lang="ts">
  ...
  type Step = "welcome" | "privacy" | "detection" | "mode" | "llm" | "gemini";
  ...
  // Mode step
  let selectedMode = $state<"local" | "cloud">("local");
  let geminiKey = $state("");
  ...
  async function finishSetup() {
    ...
    await storage.setItems([
      ...
      ...(selectedMode === "cloud" && geminiKey.trim()
            ...
            {#if step === "welcome"}
              <div class="p-8 flex flex-col items-center text-center gap-6">
                <div class="flex justify-center pt-2">
                  <img src="/icon/128.png" alt="ComicTL" class="w-20 h-20" />
                </div>

                <div class="space-y-2">
                  <h1 class="text-4xl font-bold tracking-tight">ComicTL</h1>
                ...
                <div class="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <p
                      class="text-xs text-zinc-500 dark:text-zinc-400 leading-snug"
                    >
                      All processing on your device. Fully private, works
                      offline.
                    </p>
                  </button>
                ...
                <div>
                  ...
                  <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                    ...
                    {#if selectedMode === "cloud"}
                      You can skip this since Cloud mode is active.
                    {/if}
                  </p>
                </div>
